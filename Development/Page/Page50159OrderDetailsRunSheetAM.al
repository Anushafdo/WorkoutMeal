page 50159 "Order Detail Run Sheet AM"
{
    PageType = List;
    Editable = false;
    Caption = 'Order Detail Run Sheet AM';
    ApplicationArea = All;
    UsageCategory = Administration;
    SourceTable = "Sales Header";
    SourceTableView = where(Status = filter('Open'), "Delivery Hours" = filter('AM'), IsSameDayDelivery = filter(true));
