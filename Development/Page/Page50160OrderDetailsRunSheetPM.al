page 50160 "Order Detail Run Sheet PM"
{
    PageType = List;
    Editable = false;
    Caption = 'Order Detail Run Sheet PM';
    ApplicationArea = All;
    UsageCategory = Administration;
    SourceTable = "Sales Header";
    SourceTableView = where(Status = filter('Open'), "Delivery Hours" = filter('Business Hours'), IsSameDayDelivery = filter(true));
